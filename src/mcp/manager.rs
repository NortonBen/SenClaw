...
use super::client::{McpToolInfo, SharedMcpRegistry};
use super::config::{ExternalMcpServerConfig, McpConfigManager, McpScopeType, McpServerInfo, McpServerStatus, McpToolDef, McpTransportType};
use super::external_client::ExternalMcpClient;
...
impl ExternalServerState {
    fn new(config: ExternalMcpServerConfig, scope: McpScopeType) -> Self {
        Self {
            config,
            scope,
            client: None,
