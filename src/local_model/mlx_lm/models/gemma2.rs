...
pub fn load_gemma2_model<P: AsRef<Path>>(model_dir: P) -> Result<Gemma2CausalLM, ModelError> {
    ...
    super::higgs_weights::load_quantized_safetensors_weights(&mut model, model_path, quantization.is_some())?;
...
mod tests {
    use super::*;
    use super::{
        higgs_kv::SteppingKeyValueCache,
        higgs_turboquant_mlx::{KvCacheConfig, KvCacheMode},
    };
