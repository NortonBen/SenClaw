...
pub fn scan_installed_plugins(config: &Config) -> Vec<PluginEntry> {
    ...
    let mut plugins: Vec<PluginEntry> = entries
        ...
        .filter_map(|e| {
            ...
            if slug.starts_with('.') { return None; }
            ...
            let has_binary = manifest.as_ref()
