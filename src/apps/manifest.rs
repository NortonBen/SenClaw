...
//! most of it is passed through to the Web UI untouched. The four things the
//! daemon must actually *decide* on are typed here, in one place, so a missing
//! or misspelled field has exactly one meaning:
//!
