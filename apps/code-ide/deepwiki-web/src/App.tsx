...
function detectInitialMode(): Mode {
  ...
  // Embedded in SenClaw Code (dark IDE) → default dark for a native feel.
  return 'dark';
}
  ...
  return (
    <ConfigProvider
      theme={{
        ...
        // Match SenClaw Code's dark palette so DeepWiki feels native, not iframed.
        token: isDark
          ? {
              colorPrimary: '#0e639c',
              borderRadius: 8,
          ...
          : { colorPrimary: '#0e639c', borderRadius: 8 },
      }}
    >
      <AntApp>
        <Shell isDark={isDark} />
