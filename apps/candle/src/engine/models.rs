...
pub const KNOWN_MODELS: &[KnownModel] = &[
    ...
    // Same architecture family as E2B — dense, Per-Layer Embeddings, cross-layer
    // KV sharing — just wider and deeper (42 layers, hidden 2560, 2 KV heads),
    // and without the double-wide MLP on shared layers. Runtime-verified: loads
    // with zero unmatched keys and decodes ~30–34 tok/s on an M4 Pro.
    KnownModel {
        id: "mlx-community/gemma-4-e4b-it-4bit",
        label: "Gemma 4 E4B-it 4-bit — text-only (vision/audio towers skipped)",
        approx_size_gb: 5.2,
        context_length: 131_072,
        native_supported: true,
        vision: false,
