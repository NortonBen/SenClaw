---
name: concat-fit-narrator
description: Cắt video theo độ dài TTS, burn text overlay, ghép thành video cuối
triggers:
  - ghép video theo lời
  - khớp lời bình
  - cắt theo tts
...
Usage: `/concat-fit-narrator <video_id> [--buffer 0.5] [--4k]`
...
**ABORT** if any scene has no video source. Tell user to run `/gen-videos` first.
