---
name: research
description: Kiểm chứng và nghiên cứu trước khi viết kịch bản tài liệu
triggers:
  - nghiên cứu
  - kiểm chứng
...
# research — Fact-Check & Research Before Scripting

Research and verify real-world events before creating documentary content. This skill MUST be run before `/create-project` for any documentary project.

Usage: `/research <topic> [--language vi] [--depth deep|quick]`
...
Ready for /create-project — use this research as the story source.
```

## Step 6: Handoff to Project Creation

When the user proceeds to `/create-project`, the research file serves as the **single source of truth** for:
...
```
/research "topic"          ← MUST run first
    ↓
/create-project            ← story from research
    ↓
/pipeline                  ← normal pipeline continues
```
...
```
/research "Strait of Hormuz shipping crisis 2025"
