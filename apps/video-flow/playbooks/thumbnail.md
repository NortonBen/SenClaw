---
name: thumbnail
description: Tạo 4 biến thể thumbnail tối ưu YouTube cho video
triggers:
  - tạo thumbnail
  - ảnh bìa
  - hình đại diện video
...
for i in 1 2 3 4; do
  curl -s -m 90 -X POST "http://127.0.0.1:4460/api/projects/<PID>/generate-thumbnail" \
