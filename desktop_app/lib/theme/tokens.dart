...
/// SenClaw Console — Ant Design (v5) flavored design tokens.
///
/// This retones the app to match the original antd-based web UI:
/// `colorPrimary: #5BBFE8`, antd dark base `#0D0D1F`, antd radii / control
/// heights / neutral palette. It's a theme layer over Material (the abandoned
/// `ant_design_flutter` pub package only ships a Button), so every existing
/// widget inherits the Ant Design look without a heavyweight dependency.
class AppTokens {
  AppTokens._();
