...
**Áp dụng cho:** SemaClaw / senclaw daemon · Rust port (`src/`)
...
3. [Hiện trạng bảo mật trong SemaClaw](#3-hiện-trạng-bảo-mật-trong-semaclaw)
...
### 1.2 Tại sao SemaClaw đặc biệt nhạy cảm?

SemaClaw là **agentic framework** tích hợp nhiều nguồn dữ liệu ngoài:
...
## 3. Hiện trạng bảo mật trong SemaClaw
...
```
system: "Bạn là AI assistant của SemaClaw..."
